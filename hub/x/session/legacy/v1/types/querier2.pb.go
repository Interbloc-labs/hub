...
// source: sentinel/session/v1/querier2.proto
...
func (*QuerySessionsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_3671f62b7445c4c4, []int{0}
}
...
func (*QuerySessionsForAddressRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_3671f62b7445c4c4, []int{1}
}
...
func (*QuerySessionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_3671f62b7445c4c4, []int{2}
}
...
func (*QueryParamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_3671f62b7445c4c4, []int{3}
}
...
func (*QuerySessionsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_3671f62b7445c4c4, []int{4}
}
...
func (*QuerySessionsForAddressResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_3671f62b7445c4c4, []int{5}
}
...
func (*QuerySessionResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_3671f62b7445c4c4, []int{6}
}
...
func (*QueryParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_3671f62b7445c4c4, []int{7}
}
...
func init() {
	proto.RegisterFile("sentinel/session/v1/querier2.proto", fileDescriptor_3671f62b7445c4c4)
}

var fileDescriptor_3671f62b7445c4c4 = []byte{
	// 662 bytes of a gzipped FileDescriptorProto
	,
}
...
var _QueryService_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "sentinel/session/v1/querier2.proto",
}
	...
	if m.Pagination != nil {
		{
			...
			i -= size
			i = encodeVarintQuerier2(dAtA, i, uint64(size))
		}
		i--
		dAtA[i] = 0xa
	}
...
func (m *QuerySessionsForAddressRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Status != 0 {
		i = encodeVarintQuerier2(dAtA, i, uint64(m.Status))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Address) > 0 {
		...
		i = encodeVarintQuerier2(dAtA, i, uint64(len(m.Address)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *QuerySessionRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Id != 0 {
		i = encodeVarintQuerier2(dAtA, i, uint64(m.Id))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func encodeVarintQuerier2(dAtA []byte, offset int, v uint64) int {
	offset -= sovQuerier2(v)
	base := offset
	for v >= 1<<7 {
...
func (m *QuerySessionsForAddressRequest) Size() (n int) {
	...
	if m.Status != 0 {
		n += 1 + sovQuerier2(uint64(m.Status))
	}
	if m.Pagination != nil {
		l = m.Pagination.Size()
		n += 1 + l + sovQuerier2(uint64(l))
...
func sovQuerier2(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}
func sozQuerier2(x uint64) (n int) {
	return sovQuerier2(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
func (m *QuerySessionsRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if msglen < 0 {
				return ErrInvalidLengthQuerier2
			}
		...
		default:
			iNdEx = preIndex
			skippy, err := skipQuerier2(dAtA[iNdEx:])
			if err != nil {
				return err
			}
...
func skipQuerier2(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	depth := 0
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return 0, ErrIntOverflowQuerier2
			}
			if iNdEx >= l {
		...
		case 2:
			...
			if length < 0 {
				return 0, ErrInvalidLengthQuerier2
			}
			iNdEx += length
		case 3:
			depth++
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupQuerier2
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	ErrInvalidLengthQuerier2        = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowQuerier2          = fmt.Errorf("proto: integer overflow")
	ErrUnexpectedEndOfGroupQuerier2 = fmt.Errorf("proto: unexpected end of group")
)
